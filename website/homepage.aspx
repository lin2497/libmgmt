<%@ Page Title="" Language="C#" MasterPageFile="~/head_master.master" AutoEventWireup="true" CodeFile="homepage.aspx.cs" Inherits="homepage" %>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 steps-block-col">
                        ...
                        <div>
                            <h2>STEP 2</h2>
                            <em>Pick some books and add to cart</em>
                        </div>
                        <span>&nbsp;</span>
                    </div>
                    <div class="col-md-4 steps-block-col">
