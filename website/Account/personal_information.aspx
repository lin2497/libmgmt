<%@ Page Title="" Language="C#" MasterPageFile="~/head_master.master" AutoEventWireup="true" CodeFile="personal_information.aspx.cs" Inherits="personal_information" %>
                        ...
                        <div role="form" class="form-horizontal form-without-legend">
                            <div class="panel-body row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label" for="first-name">E-Mail <span class="require">*</span></label>
                                        <div class="col-lg-8">
                                            <asp:TextBox runat="server" ID="txt_email" CssClass="form-control" TextMode="Email" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label" for="first-name">First Name <span class="require">*</span></label>
                                        <div class="col-lg-8">
                                            <asp:TextBox runat="server" ID="txt_first_name" CssClass="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label" for="last-name">Last Name <span class="require">*</span></label>
                                        <div class="col-lg-8">
                                            <asp:TextBox runat="server" ID="txt_last_name" CssClass="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label" for="telephone">Telephone </label>
                                        <div class="col-lg-8">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label" for="post">Post Code</label>
                                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-offset-2 padding-left-0 padding-top-20">
                                    <asp:Button ID="btn_renew" runat="server" Text="Update Info" CssClass="btn btn-primary" OnClick="btn_renew_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
